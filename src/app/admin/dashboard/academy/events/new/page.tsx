  ...
  return (
    <div className="space-y-8 pb-20">
      ...
      <div className="max-w-4xl">
        <h1 className="text-3xl font-montserrat font-black text-white mb-2">Ajouter un Événement</h1>
        <p className="text-slate-500 font-inter">Créez un nouvel événement (Webinaire, Conférence, etc.)</p>
      </div>
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="bg-slate-900/40 border border-slate-800 rounded-[32px] p-8 space-y-6">
            <div className="space-y-2">
              ...
              <input {...register("title")} className="w-full bg-slate-950 border border-slate-800 rounded-2xl py-4 px-6 text-white focus:border-orange-500 outline-none transition-all" placeholder="Ex: Webinaire sur la Gouvernance 2026" />
              {errors.title && <p className="text-red-400 text-xs mt-1">{errors.title.message}</p>}
            </div>

            <div className="space-y-2">
              <label className="text-xs font-bold text-slate-500 uppercase tracking-widest ml-1">Description</label>
              <textarea {...register("description")} className="w-full bg-slate-950 border border-slate-800 rounded-2xl py-4 px-6 text-white focus:border-orange-500 outline-none transition-all min-h-[200px]" placeholder="Détails de l'événement..." />
        ...
        <div className="space-y-6">
          <div className="bg-slate-900/40 border border-slate-800 rounded-[32px] p-8 space-y-6">
            ...
            <div className="space-y-2">
              ...
              <input {...register("venue")} className="w-full bg-slate-950 border border-slate-800 rounded-xl py-3 px-4 text-white focus:border-orange-500 outline-none" placeholder="Ex: Cotonou ou Zoom" />
            </div>
          ...
          >
            ...
            {isSubmitting ? "Création..." : "Enregistrer l'événement"}
          </button>
