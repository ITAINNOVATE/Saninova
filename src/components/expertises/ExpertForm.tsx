...
export default function ExpertForm() {
  ...
  return (
    <section className="py-16 bg-light border-t border-light mt-16" id="expert-form">
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="bg-white p-8 md:p-12 rounded-3xl shadow-sm border border-light">
          {success ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-10">
              ...
              <div className="space-y-6">
                <h3 className="font-montserrat text-xl font-bold border-b pb-2 text-primary">1. INFORMATIONS PERSONNELLES</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    <label className="text-sm font-semibold text-primary font-poppins">Nom *</label>
                    <input type="text" name="last_name" required value={formData.last_name} onChange={handleChange} className="w-full px-4 py-3 rounded-xl border border-light focus:border-orange focus:ring-2 focus:ring-orange/20 outline-none" placeholder="Nom de famille" />
                  </div>
                  <div className="space-y-2">
                    <label className="text-sm font-semibold text-primary font-poppins">Prénom *</label>
                    <input type="text" name="first_name" required value={formData.first_name} onChange={handleChange} className="w-full px-4 py-3 rounded-xl border border-light focus:border-orange focus:ring-2 focus:ring-orange/20 outline-none" placeholder="Prénom" />
                  </div>
                  <div className="space-y-2">
                    <label className="text-sm font-semibold text-primary font-poppins">Adresse e-mail *</label>
                  ...
                  <div className="space-y-2">
                    ...
                    <input type="text" name="country" required value={formData.country} onChange={handleChange} className="w-full px-4 py-3 rounded-xl border border-light focus:border-orange focus:ring-2 focus:ring-orange/20 outline-none" placeholder="Ex. Bénin, Côte d'Ivoire, France..." />
                  </div>
                  <div className="space-y-2">
                    <label className="text-sm font-semibold text-primary font-poppins">Ville</label>
                    <input type="text" name="city" value={formData.city} onChange={handleChange} className="w-full px-4 py-3 rounded-xl border border-light focus:border-orange focus:ring-2 focus:ring-orange/20 outline-none" placeholder="Ex. Cotonou" />
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-6">
                <h3 className="font-montserrat text-xl font-bold border-b pb-2 text-primary">2. PROFIL PROFESSIONNEL</h3>
                
                <div className="space-y-3">
                  <label className="text-sm font-semibold text-primary font-poppins">Situation professionnelle *</label>
                ...
                {formData.professional_status === "En Poste" && (
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 p-4 bg-slate-50 rounded-xl">
                    <div className="space-y-2">
                      <label className="text-sm font-semibold text-primary font-poppins">Titre / Poste actuel *</label>
                      <input type="text" name="job_title" required value={formData.job_title} onChange={handleChange} className="w-full px-4 py-3 rounded-xl border border-light focus:border-orange outline-none" placeholder="Ex. Médecin épidémiologiste..." />
                    </div>
                    <div className="space-y-2">
                      <label className="text-sm font-semibold text-primary font-poppins">Institution / Organisation actuelle *</label>
                      <input type="text" name="institution" required value={formData.institution} onChange={handleChange} className="w-full px-4 py-3 rounded-xl border border-light focus:border-orange outline-none" placeholder="Ex. OMS, Ministère..." />
                    </div>
                  </div>
                )}

                <div className="space-y-3">
                  <label className="text-sm font-semibold text-primary font-poppins">Années d'expérience *</label>
                ...
                <div className="space-y-3">
                  <label className="text-sm font-semibold text-primary font-poppins">Niveau de formation le plus élevé</label>
              ...
              <div className="space-y-6">
                <h3 className="font-montserrat text-xl font-bold border-b pb-2 text-primary">3. DOMAINES D'EXPERTISE</h3>
                <div className="space-y-3">
                  <label className="text-sm font-semibold text-primary font-poppins block">Domaines principaux (plusieurs choix possibles) *</label>
                  ...
                  <input type="text" placeholder="Autre (à préciser)" className="w-full mt-3 px-4 py-2 rounded-xl border border-light focus:border-orange outline-none text-sm" onChange={(e) => {
              ...
              <div className="space-y-6">
                <h3 className="font-montserrat text-xl font-bold border-b pb-2 text-primary">4. DISPONIBILITÉ & MODALITÉS</h3>
                
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div className="space-y-3">
                    <label className="text-sm font-semibold text-primary font-poppins block">Type de collaboration souhaité</label>
                    <div className="space-y-2">
                  ...
                  <div className="space-y-6">
                    <div className="space-y-3">
                      <label className="text-sm font-semibold text-primary font-poppins block">Disponibilité générale</label>
                      <div className="space-y-2">
                    ...
                    <div className="space-y-3">
                      <label className="text-sm font-semibold text-primary font-poppins block">Langues de travail</label>
                      <div className="flex flex-wrap gap-4">
              ...
              {/* 5. COMPLÉMENTS */}
              <div className="space-y-6">
                <h3 className="font-montserrat text-xl font-bold border-b pb-2 text-primary">5. COMPLÉMENTS</h3>
                
                <div className="space-y-2">
                  <label className="text-sm font-semibold text-primary font-poppins">Brève biographie ou note de présentation</label>
                  <textarea name="biography" rows={4} value={formData.biography} onChange={handleChange} className="w-full px-4 py-3 rounded-xl border border-light focus:border-orange outline-none resize-none" placeholder="En 3 à 5 lignes, décrivez votre parcours et vos principales réalisations..."></textarea>
                </div>

                <div className="space-y-2">
                  <label className="text-sm font-semibold text-primary font-poppins">Lien vers votre profil professionnel</label>
                  <input type="url" name="cv_link" value={formData.cv_link} onChange={handleChange} className="w-full px-4 py-3 rounded-xl border border-light focus:border-orange outline-none" placeholder="https://linkedin.com/in/... ou lien vers CV en ligne" />
                </div>
              ...
              <div className="pt-4 flex flex-col md:flex-row items-center justify-between gap-4 border-t border-light">
                <p className="text-xs text-slate-500">© 2026 SaniNova Global Consulting — Tous droits réservés</p>
                <button
                  type="submit"
