            ...
            <form onSubmit={handleSubmit} className="space-y-10">
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-2 mt-4">
                  ...
                  <input type="url" name="cv_link" value={formData.cv_link} onChange={handleChange} className="w-full px-4 py-3 rounded-xl bg-white/5 border border-white/10 text-white placeholder-white/40 focus:border-orange outline-none" placeholder="https://linkedin.com/in/... " />
                </div>
