            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start space-x-3 sm:space-x-4">
                ...
                <div className="space-y-1">
                  ...
                  <p className="font-inter text-sm sm:text-base text-dark/70 leading-relaxed text-justify hyphens-auto break-words">{currentDetails.problem}</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-3 sm:space-x-4">
                ...
                <div className="space-y-1">
                  ...
                  <p className="font-inter text-sm sm:text-base text-dark/70 leading-relaxed text-justify hyphens-auto break-words">{currentDetails.solution}</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-3 sm:space-x-4">
                ...
                <div className="space-y-1">
                  ...
                  <p className="font-inter text-sm sm:text-base text-dark/70 leading-relaxed text-justify hyphens-auto break-words">{currentDetails.result}</p>
                </div>
              </div>
            </div>
