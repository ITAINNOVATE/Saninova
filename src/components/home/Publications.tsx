              ...
              return (
                ...
                >
                  ...
                  <Link href={`/publications/${article.id}`} className="flex flex-col flex-grow">
                    ...
                    <div className="p-6 flex flex-col flex-grow justify-between space-y-6">
                      <div className="space-y-3">
                        ...
                        <p className="font-inter text-sm sm:text-base text-dark/70 leading-relaxed line-clamp-3 text-justify hyphens-auto break-words">
                          {article.desc}
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="px-6 pb-6 pt-4 border-t border-light/60 flex items-center justify-between bg-slate-50/50 mt-auto">
                    ...
                    {/* View Article Link with Arrow in a Solid White Rounded Pill Box */}
                    <Link 
                      href={`/publications/${article.id}`}
                      className="bg-white hover:bg-slate-50 text-orange hover:text-orange/80 px-3.5 py-1.5 rounded-full shadow-md border border-orange/10 flex items-center space-x-1.5 transition-all shrink-0 animate-pulse font-poppins text-[11px] font-extrabold"
                    >
