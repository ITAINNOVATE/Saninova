        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="space-y-6">
            ...
            <ul className="space-y-3 font-poppins text-lg text-white/70">
              ...
              <li>
                <Link href="/ressources" className="hover:text-accent transition-colors duration-200">
                  {t.nav.resources}
                </Link>
              </li>
              <li>
          ...
          <div className="space-y-6">
            ...
            <ul className="space-y-4 font-inter text-base sm:text-lg text-white/70">
              ...
              <li className="flex items-center space-x-3">
                ...
                <a href="tel:+2290193030333" className="hover:text-accent transition-colors">
                  +229 01 93 03 03 33
                </a>
              </li>
              <li className="flex items-center space-x-3">
                <Mail className="w-5 h-5 text-accent shrink-0" />
                <a href="mailto:contact@saninovagc.com" className="hover:text-accent transition-colors">
                  contact@saninovagc.com
                </a>
              </li>
            </ul>
          </div>
