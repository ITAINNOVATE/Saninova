...
import { Mail, Phone, MapPin, ArrowUp, Facebook, Linkedin, Instagram, Youtube } from "lucide-react";

export const Footer: React.FC = () => {
  const { t } = useLanguage();

  const socialLinks = [
    { icon: <Linkedin className="w-5 h-5" />, href: "https://www.linkedin.com/company/saninova-global-consulting/" },
    { icon: <Facebook className="w-5 h-5" />, href: "https://web.facebook.com/profile.php?id=61589394335585" },
    { icon: <Instagram className="w-5 h-5" />, href: "https://www.instagram.com/saninovagc/" },
    { icon: <Youtube className="w-5 h-5" />, href: "https://www.youtube.com/@SaniNovaGlobalConsulting" },
  ];
