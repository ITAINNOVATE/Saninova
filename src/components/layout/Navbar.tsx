...
import { Menu, X, Globe, PhoneCall, Mail, Phone, Facebook, Linkedin, Instagram, Youtube } from "lucide-react";
...
export const Navbar: React.FC = () => {
  ...
  const socialLinks = [
    { icon: <Facebook className="w-3.5 h-3.5" />, href: "https://web.facebook.com/profile.php?id=61589394335585" },
    { icon: <Linkedin className="w-3.5 h-3.5" />, href: "https://www.linkedin.com/company/saninova-global-consulting/" },
    { icon: <Instagram className="w-3.5 h-3.5" />, href: "https://www.instagram.com/saninovagc/" },
    { icon: <Youtube className="w-3.5 h-3.5" />, href: "https://www.youtube.com/@SaniNovaGlobalConsulting" },
  ];
