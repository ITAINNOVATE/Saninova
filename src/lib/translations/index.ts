        ...
        members: [
          {
            ...
            details: "« Notre vision chez SaniNova Global Consulting est claire : transformer en profondeur les systèmes de santé en Afrique. En tant que Président Directeur Général, mon engagement est d'accompagner les gouvernements et les partenaires au développement dans la conception et la mise en œuvre de réformes sanitaires ambitieuses. En alliant notre expertise multidisciplinaire — de la gouvernance sanitaire à la santé digitale — nous œuvrons chaque jour pour bâtir des systèmes de santé plus résilients, équitables et performants pour notre continent. »",
            tags: ["Gouvernance sanitaire", "Supply Chain", "Santé digitale", "Réglementation", "Leadership stratégique"],
          },
          {
            ...
            details: "Dr Ghislaine LOKO DJIDJOHO est Directrice Technique en charge de la Santé Publique au sein de SaniNova. Spécialiste en épidémiologie et en gestion des programmes de santé, elle apporte une expertise de terrain dans la conception et la mise en œuvre d’interventions de santé publique adaptées aux réalités africaines. Elle supervise les missions d’appui aux programmes nationaux de santé et les évaluations de performance.",
            tags: ["Santé publique", "Épidémiologie", "Programmes de santé", "Suivi-évaluation"],
          },
          {
            ...
            details: "Mylène Fatima ADIGOUN est Directrice Technique en charge de la Digitalisation et des Systèmes d’Information à SaniNova. Ingénieure de formation, elle possède une expertise pointue dans la conception et le déploiement de systèmes d’information sanitaires (eLMIS, DHIS2), la traitement des données de santé et la transformation numérique des institutions. Elle a piloté plusieurs projets de digitalisation d’envergure nationale.",
            tags: ["eLMIS", "DHIS2", "Santé digitale", "Data analytics", "Transformation numérique"],
          },
          {
            name: "Dr Lucresse Agathe Corine FASSINOU",
            role: "Directrice Technique chargée des Études",
            desc: "Experte en ingénierie pédagogique et élaboration de programmes de formation en santé.",
            details: "Dr Lucresse Agathe Corine FASSINOU est Directrice Technique en charge des Études à SaniNova. Elle supervise la conception et la coordination des études stratégiques, des recherches opérationnelles et des programmes de formation. Experte en ingénierie pédagogique, elle s’assure que les contenus développés répondent aux standards internationaux et aux besoins spécifiques des institutions africaines.",
            tags: ["Ingénierie pédagogique", "Études stratégiques", "Formation en santé", "Recherche opérationnelle"],
          },
          {
            ...
            details: "Dr Mechak Eurudice Mahoussi GBETCHEDJI est Directrice Technique chargée des Projets à SaniNova. Elle assure la coordination et le suivi opérationnel des projets de santé d’envergure internationale. Experte en gestion de projets complexes, elle travaille en étroite collaboration avec les gouvernements, les partenaires techniques et financiers pour garantir la livraison des résultats attendus dans les délais impartis.",
          ...
          },
          {
            ...
            details: "Dr Ambroise Tchando NAHINI est Conseiller en Développement Institutionnel à SaniNova. Il accompagne les institutions de santé dans leur transformation organisationnelle, le renforcement de leurs capacités et l’amélioration de leur gouvernance. Son expertise couvre les réformes institutionnelles, la planification stratégique et le développement des compétences au sein des structures de santé publiques et privées.",
            tags: ["Développement institutionnel", "Réformes organisationnelles", "Gouvernance", "Planification stratégique"],
          },
          {
            ...
            details: "Nicolas Hamondji AMÉGAN est Responsable Académique de la SaniNova Academy. Il coordonne l’ensemble des programmes de formation, des certifications professionnelles et des activités pédagogiques proposés par SaniNova. Il veille à la qualité des contenus, au bon déroulement des sessions de formation et à la satisfaction des apprenants issus de toute l’Afrique.",
            tags: ["Formation professionnelle", "Certifications", "Pédagogie", "SaniNova Academy"],
          },
          {
            name: "Arafath IMOROU",
        ...
        members: [
          {
            ...
            details: "Dr Hope AKOHOUVI AMOU is the Managing Director of SaniNova Global Consulting. A recognized international expert, he advises African governments and development partners on the design and implementation of ambitious health reforms. With multidisciplinary experience spanning health governance, pharmaceutical supply chain, digital health, and health security, he leads SaniNova with a clear strategic vision focused on resilient, equitable, and high-performing health systems.",
            tags: ["Health Governance", "Supply Chain", "Digital Health", "Regulation", "Strategic Leadership"],
          },
          {
            name: "Dr Ghislaine LOKO DJIDJOHO",
            role: "Technical Director - Public Health",
            desc: "Specialist in public health and epidemiology.",
            details: "Dr Ghislaine LOKO DJIDJOHO is Technical Director in charge of Public Health at SaniNova. A specialist in epidemiology and health program management, she brings field expertise in designing and implementing public health interventions adapted to African realities. She oversees support missions for national health programs and performance evaluations.",
            tags: ["Public Health", "Epidemiology", "Health Programs", "Monitoring & Evaluation"],
          },
          {
            name: "Mylène Fatima ADIGOUN",
            ...
            details: "Mylène Fatima ADIGOUN is Technical Director in charge of Digitalization and Health Information Systems at SaniNova. An engineer by training, she has sharp expertise in the design and deployment of health information systems (eLMIS, DHIS2), health data processing, and digital transformation of institutions. She has led several national-scale digitalization projects.",
            tags: ["eLMIS", "DHIS2", "Digital Health", "Data Analytics", "Digital Transformation"],
          },
          {
            name: "Dr Lucresse Agathe Corine FASSINOU",
            role: "Technical Director - Director of Studies",
            desc: "Expert in educational engineering and development of health training programs.",
            details: "Dr Lucresse Agathe Corine FASSINOU is Technical Director in charge of Studies at SaniNova. She oversees the design and coordination of strategic studies, operational research, and training programs. An expert in educational engineering, she ensures that the content developed meets international standards and the specific needs of African institutions.",
            tags: ["Educational Engineering", "Strategic Studies", "Health Training", "Operational Research"],
          },
          {
            name: "Dr Mechak Eurudice Mahoussi GBETCHEDJI",
            ...
            details: "Dr Mechak Eurudice Mahoussi GBETCHEDJI is Technical Director in charge of Projects at SaniNova. She ensures the coordination and operational monitoring of large-scale international health projects. An expert in complex project management, she works closely with governments, technical and financial partners to ensure the delivery of expected results within deadlines.",
          ...
          },
          {
            ...
            details: "Dr Ambroise Tchando NAHINI is Advisor in Institutional Development at SaniNova. He supports health institutions in their organizational transformation, capacity building, and governance improvement. His expertise covers institutional reforms, strategic planning, and skills development within public and private health structures.",
            tags: ["Institutional Development", "Organizational Reforms", "Governance", "Strategic Planning"],
          },
          {
            name: "Nicolas Hamondji AMÉGAN",
            role: "Academic Manager",
            desc: "Coordinator of training programs and certifications at SaniNova Academy.",
            details: "Nicolas Hamondji AMÉGAN is Academic Manager of SaniNova Academy. He coordinates all training programs, professional certifications, and pedagogical activities offered by SaniNova. He ensures content quality, smooth delivery of training sessions, and learner satisfaction across Africa.",
            tags: ["Professional Training", "Certifications", "Pedagogy", "SaniNova Academy"],
          },
          {
            name: "Arafath IMOROU",
